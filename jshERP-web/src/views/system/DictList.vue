            ...
            <a-row :gutter="24">
              <a-col :md="6" :sm="24">
                <a-form-item label="字典名称" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input placeholder="请输入字典名称" v-model="queryParam.loginName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
                <a-form-item label="字典类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
                  <a-input placeholder="请输入字典类型" v-model="queryParam.loginName"></a-input>
                </a-form-item>
              </a-col>
              <a-col :md="6" :sm="24">
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '字典名称', dataIndex: 'dictName', width: 100, align: "center"},
          { title: '字典类型', dataIndex: 'dictType', width: 100, align: "center"},
        ...
        url: {
          ...
          refreshCacheUrl: "/system/dict/type/refreshCache"
        },
      }
    },
    created () {
